...
make_boxplot <- function(df, df_name, y, y_name, ylims, fill_var, fill_if_statement){
  yvar <- enquo(y)
...
make_contour_plot <- function(df, df_name, y, y_name, ylims, fill_var, fill_if_statement){
  yvar <- enquo(y)
  fil_var <- enquo(fill_var)
  ggplot(df)+
