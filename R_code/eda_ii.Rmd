...
library(magrittr)
library(usmap)
catch <- read_csv("data2/Shelf_Flatfish_Haul_Catch.csv", guess_max = 10000)
len <- read_csv("data2/Shelf_Flatfish_Haul_Catch_Length.csv", guess_max = 10000)
# length_spec <- read_csv("data2/Shelf_Flatfish_Haul_Catch_Length_Specimen.csv", guess_max = 10000)
bot <- read_csv("bottom_type.csv", guess_max = 10000)
```
