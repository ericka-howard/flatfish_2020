...
STATION_AVG_DEPTH<-tapply(catch$AVG_LAT,catch$STATIONID,mean)
...
more_for_plot <- full_join(for_plot, station_info, by="STATIONID")
...
idk wtf is going on with the scale up there
